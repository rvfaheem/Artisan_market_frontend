...
<div className=' opacity-90 m-4 w-[400px] h-FIT'>
            ...
            <h1 class="mb-2 text-[30px] font-extrabold text-gray-900 dark:text-white md:text-xl  text-[50px]"><span class="text-[30px] text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400 text-[20px]">Artist Registration</span> </h1>
              {/* <p>REGISTRATION</p>
              <p> FORM</p> */}
              </label></div>
              ...
              <div className='p-3'>
                ...
                <input onChange={handleChange} className='w-[100%] text-black placeholder:text-black border-b-4' required name="name" pattern="^[a-zA-Z ]*$" title="Only alphabets are allowed"   type="text" placeholder='name'  />
                </div>
                <div className='p-3'>
                  <label>Image</label>
                ...
                <div className='p-3'>
                <input onChange={handleChange} required name="category" pattern="^[a-zA-Z ]*$" title="Only alphabets are allowed" className='w-[100%] text-black placeholder:text-black border-b-4' type="text" placeholder='G-category' />
                </div>      
                <div className='p-3'>
                <label>Art_work</label>
                <input onChange={handlefile} required name="artwork" className='w-[100%] bor' type="file" />
                </div>                
                <div className='p-3'>
