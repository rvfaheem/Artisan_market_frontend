...
export const A_registration_form = () => {
  ...
  let handleSubmit=async (event)=>{
    ...
    let formData = new FormData();
        ...
        formData.append('id_proof', data.category);
...
<div className='bg-sky-600 opacity-100 w-96 h-FIT'>
         ...
         NAME
                ...
                <input onChange={handleChange} name="category" type="text" placeholder='G-category' />
                </div>      
                <div className='p-3'>
                <label className=' text-gray-500 font-bold'>ARTWORK</label><br />
                <input onChange={handlefile} name="art_work" type="file" />
                </div>                
                <div className='p-3'>
