  ...
  return (
    ...
    <div>
        ...
        <div class='category px-96 bg-center pt-8 ml-34 flex justify-center'>
          ...
          <div className='bg-[#AED0E9] flex flex-col justify-center items-center w-9/12 h-70 p-14 ml-9 mb-48 mt-32 gap-4 rounded-xl'>
            <form onSubmit={handleSubmit}>
           <div className="flex gap-2">
           <label className='font-semibold text-[25px]'>ADD CATEGORY:</label>
           <input onChange={handleChanage} name='category' className='mb-6 px-67 h-8 w-56 rounded' type="text" />
            
           </div>
           <div className='text-center'>
            <button className= 'p-3 m-2 font-bold text-[26px] bg-green-600 w-44 mt-67' type="submit">Add</button></div>
           </form>
            <div>
