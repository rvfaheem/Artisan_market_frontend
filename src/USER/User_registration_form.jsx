...
<div className=' opacity-90 m-4 w-[400px] h-FIT'>
            ...
            <h1 class="mb-2 text-[30px] font-extrabold text-gray-900 dark:text-white md:text-xl  text-[50px]"><span class="text-[30px] text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400 text-[20px]">User Registration</span> </h1>
              {/* <p>REGISTRATION</p>
              <p> FORM</p> */}
              </label></div>
