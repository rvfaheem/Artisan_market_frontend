...
export const Exihibition = () => {
  return (
    <div>
          <div>
        <div className='text-[30px] font-bold'>EXIHIBITION</div><br />
        <div className='flex flex-wrap gap-6'>
            


<div class="min-h-screen  flex justify-center items-center">
  <div class="organise flex flex-col justify-between w-72 sm:w-96 h-96 bg-white bg-center text-gray-800 shadow-md overflow-hidden cursor-pointer"> 
  {/* style="background-image:url('https://placeimg.com/480/480/any')" */}
    ...
    <div class="bg-white bg-opacity-95 shadow-md rounded-r-xl p-4 flex flex-col mr-4 mb-8">
      <h3 class="text-xl font-bold pb-2">Painting</h3>
...
<div class="min-h-screen  flex justify-center items-center">
  ...
  {/* style="background-image:url('https://placeimg.com/480/480/any')" */}
    ...
    <div class="bg-white bg-opacity-95 shadow-md rounded-r-xl p-4 flex flex-col mr-4 mb-8">
      <h3 class="text-xl font-bold pb-2">Bottle Art</h3>
      {/* <p class="truncate text-gray-500 text-sm">Nowruz is the Persian New Year, which begins on the Spring equinox, marking the first day of Farvardin, the first month of the Iranian solar calendar.</p> */}
      <div class="flex justify-between items-center">
        {/* <span class="text-gray-400 text-xs">Have a nice year...</span> */}
      </div>
...
<div class="min-h-screen  flex justify-center items-center">
  ...
  {/* style="background-image:url('https://placeimg.com/480/480/any')" */}
    ...
    <div class="bg-white bg-opacity-95 shadow-md rounded-r-xl p-4 flex flex-col mr-4 mb-8">
      <h3 class="text-xl font-bold pb-2">Drawing</h3>
      {/* <p class="truncate text-gray-500 text-sm">Nowruz is the Persian New Year, which begins on the Spring equinox, marking the first day of Farvardin, the first month of the Iranian solar calendar.</p> */}
      <div class="flex justify-between items-center">
        {/* <span class="text-gray-400 text-xs">Have a nice year...</span> */}
      </div>
