...
export const Login = () => {
  ...
  const [data,setData]=useState('')
    ...
    let handleSubmit=async(event)=>{
      ...
      let response=await axios.post('https://artisan-market-backend.onrender.com/login',data)
      console.log(response);
      if(response.data){
        localStorage.setItem('id',response.data._id)
        localStorage.setItem('gmail',response.data.gmail)
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                  ...
                  <form onSubmit={handleSubmit} class="space-y-4 md:space-y-6" >
                    <div>
                      ...
                      <input onChange={handleChange} type="gmail" name="gmail" id="gmail" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@gmail.com" required="" />
                    </div>
                    <div>
                    ...
                    <div class="flex items-center justify-between">
                      ...
                      {/* </div> */}
                      <a href="/otp" class="text-sm font-medium text-primary-600 hover:underline dark:text-primary-500">Forgot password?</a>
                    </div>
